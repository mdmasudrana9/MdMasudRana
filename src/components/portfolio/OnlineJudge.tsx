  ...
  return (
    <section id="judges" className="py-24">
      <div className="section-container">
        ...
        >
          <p className="font-mono text-sm text-primary mb-2">{"// Competitive Programming"}</p>
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4">
                <div className="text-center">
                  <p className="text-xl font-bold text-foreground">{profile.solved}</p>
                  <p className="text-[10px] text-muted-foreground uppercase tracking-wider">Solved</p>
                </div>
                {profile.rating && (
                  <div className="text-center">
                    <p className="text-xl font-bold flex items-center gap-1" style={{ color: profile.color }}>
                      <Trophy size={14} />
                      {profile.rating}
                    </p>
